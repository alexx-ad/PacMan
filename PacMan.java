...
public class PacMan extends JPanel implements ActionListener, KeyListener {
    ...
    public void draw(Graphics g) {
        ...
        if (gameOver && !foodEmpty){
            g.drawString("Game Over: " + String.valueOf(score), tileSize / 2, tileSize / 2);
            g.drawString("Press any key to play again.", tileSize * 2, tileSize * 2);
        } else if (gameOver && foodEmpty) {
           g.drawString("You have won. Congratulations!", tileSize / 2, tileSize / 2); 
        } else {
